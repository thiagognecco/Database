#!/usr/bin/env python3
"""Traduz os últimos 145 resumos em inglês"""
...
print("="*80)
print("TRADUCAO 100%: 145 resumos FINAIS em INGLES -> PT-BR")
print("="*80 + "\n")
...
english_words = {
    ...
    "link", "reel", "post", "video", "article", "guide", "tutorial", "page"
}
...
print("RESULTADO")
print("="*80)
print(f"Traduzidos: {traduzidos}/{len(links_en)}")
print(f"Erros: {erros}")
